...
class UI extends Component {
    ...
    changeToMaxarImage() {
        ...
        this.state.view.goTo({ center: [112.84350452926209, -8.054735059174224], zoom: 18 }).then(_ => {
            //set the state
            this.setState({ mode: 'webtile_layer', status_text: 'Getting image from OpenAerialMap..', feature_collection: undefined, wms_endpoint: 'https://corsproxy.io/?url=https://tiles.openaerialmap.org/61b94e69b26de1000596d605/1/61b94e69b26de1000596d607/{z}/{x}/{y}', wms_copyright: 'Imagery from OpenAerialMap. Maxar Products. WorldView2 © 2021 Maxar Technologies.' });
        });
    }
