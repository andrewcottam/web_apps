...
require({
	...
	ready(function() {
		...
		restServerUrl = "http://dopa-services.jrc.ec.europa.eu/services/gee";
		geeServerUrl = "http://dopa-services.jrc.ec.europa.eu/gee";
		geeImageServerUrl = "http://geeImageServer.appspot.com";
