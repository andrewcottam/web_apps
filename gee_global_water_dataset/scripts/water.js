	...
	ready(function() {
		...
		function getMonthlyRecurrence(latLong){
			...
			script.get(geeServerUrl + "/monthlyRecurrence", {
				...
				monthlyRecurrenceChart.addSeries("series1", {data: recurrenceData});
				monthlyRecurrenceChart.addSeries("series2", {data: obsData});
		...
		function getYearlyClassifications(latLong){
			...
			script.get(geeServerUrl + "/yearlyClassifications", {
				...
				yearlyClassificationsChart.addSeries("series1", {data: yearlyData});
