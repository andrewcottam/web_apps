...
### esri1.html
ArcGIS Maps SDK for Javascript client which uses a simple [ImageryTileLayer](https://developers.arcgis.com/javascript/latest/api-reference/esri-layers-ImageryTileLayer.html) to directly access the publicly available COG file. This does not use TiTiler in between.
...
### index.html
ESRI Javascript COG demo. Start with:
```
cd cog-clients
npm install
npm run start
