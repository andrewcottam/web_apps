...
|Restor Live Tree Detection|View the tree detections live on drone data, aerial and satellite imagery using the Restor tree detection model|<a href='https://andrewcottam.github.io/web_apps/tree-detection/build/index.html?model=restor'>Online</a>
|Restor Live Tree Detection|View the tree detections live on drone data, aerial and satellite imagery using the University of Cambridge tree detection model (tuned to closed canopy)|<a href='https://andrewcottam.github.io/web_apps/tree-detection/build/index.html'>Online</a>
