...
define(["esri/geometry/Extent", "esri/graphic", "esri/Color", "esri/symbols/SimpleLineSymbol", "esri/symbols/SimpleMarkerSymbol", "esri/layers/GraphicsLayer", "esri/geometry/Point", "esri/geometry/screenUtils", "esri/geometry/webMercatorUtils", "dojo/_base/array", "dojo/dom-geometry", "dojox/gfx", "dojo/window", "dojo/query", "dojo/dom-style", "dojo/dom-construct", "widgetsPath/PhotoBoxPanoramio", "widgetsPath/PhotoBoxFlickr", "dijit/registry", "dojo/on", "widgetsPath/WebServiceAPIs/PanoramioAPI", "widgetsPath/WebServiceAPIs/MapSightsAPI", "widgetsPath/WebServiceAPIs/FlickrAPI", "dojo/_base/lang", "dojo/dom", "dojo/_base/declare", "dijit/_WidgetBase", "dijit/_TemplatedMixin", "dojo/text!./templates/PhotoViewer.html"], 
function(Extent, Graphic, Color, SimpleLineSymbol, SimpleMarkerSymbol, GraphicsLayer, Point, screenUtils, webMercatorUtils, array, domGeom, gfx, dojowindow, query, domStyle, domConstruct, PhotoBoxPanoramio, PhotoBoxFlickr, registry, on, PanoramioAPI, MapSightsAPI, FlickrAPI, lang, dom, declare, _WidgetBase, _TemplatedMixin, template) {
