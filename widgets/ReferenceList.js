...
define(["dijit/registry", "dojo/_base/lang", "dojo/_base/array", "dojo/request/xhr", "dojo/dom-construct", "widgets/ReferenceBox", "dojo/_base/declare","dojo/parser", "dojo/ready", "dijit/_WidgetBase", "dijit/_TemplatedMixin", "dojo/text!./templates/ReferenceList.html" ],
...
//							subj: "390,391,39,42,392,393,394,395,187,396,213,86,87,90,116,118,172,17,88,89,101,102,103,125,128,148,163,188,218,219,484,92,117,127,215", //this is slow!!
						...
						array.forEach(references, lang.hitch(this, function(reference) {
							var referenceBox = new ReferenceBox({reference: reference});
